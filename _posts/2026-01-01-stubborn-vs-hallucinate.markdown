...
* สั่งว่า "ห้ามใส่ Emoji" น้องแกก็ตอบกลับมาว่า *"ได้ครับ! ไม่ใส่แล้วครับ 😊"* (แน่ะ! ยังจะแถม Emoji มาอีก)
...
2. **AI "ดื้อ" (Stubborn):** น้องมีข้อมูลในหัวแน่นปึ้กว่า "แมวตัวใหญ่" (Big Cat) คือ เสือหรือเสือดาว พอบอกให้ทำโชว์ น้องก็เลยส่งเสือดาวมาให้ โดย **"เพิกเฉย"** บริบทของโรงละครสัตว์ (ที่อาจจะไม่ได้มีเสือดาวแสดงจริงๆ) หรือข้อมูลหน้างานที่เราบอกไปแล้ว น้องเลือกเชื่อความรู้เดิมที่ฝังหัวมามากกว่าครับ
...
วันดีคืนดี เรายื่นกระดาษโน้ตแผ่นเล็กๆ (Prompt/Context) ให้มันแล้วบอกว่า *“ให้เชื่อกระดาษแผ่นนี้”* ต่อให้เป็นคนก็อาจจะดือได้เหมือนกัน 😅

ต้นเหตุของความดื้อจะแบ่งได้สองประเด็น
...
2. **Negative Constraint Failure:** ยิ่งถ้าเราสั่งด้วยคำว่า "ห้าม" (เช่น ห้ามตอบยาว, ห้ามขายของที่ไม่มี) สมอง AI จะทำงานคล้ายคนครับ คือพอบอกว่า *"อย่าคิดถึงช้างสีชมพู"*... ปุ๊บ! ในหัวเห็นช้างสีชมพูทันที  
...
#### 3. กำหนดแล่งอ้างอิง หรือบอกลำดับความสำคัญ (🧑‍⚖️ Source of Truth)
...
| **อันนี้ท่าไม้ตาย ได้ผลชัดแน่ๆ แต่ก็มีความเสี่ยง** เสียงอย่างไรไว้เรามาคุยกัน 😊
